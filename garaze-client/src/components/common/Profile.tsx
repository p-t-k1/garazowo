...
import { ProfileProps, ParkingSpaceProps } from "interfaces/common";
...
const Profile = ({ type, name, avatar, email, parkingSpaces }: ProfileProps) => (
    <Box>
        ...
        {parkingSpaces.length > 0 && (
            <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#FCFCFC">
                ...
                >
                    {parkingSpaces?.map((property: ParkingSpaceProps) => (
                        <ParkingSpaceCard
                            key={property._id}
                            id={property._id}
